...
pub fn messages() -> Messages {
    match language() {
        Language::ZhCn => Messages {
            ...
            help_config: "配置文件路径（默认依次查找 java-runner2026.toml、config/java-runner2026.toml）",
        ...
        Language::En => Messages {
            ...
            help_config: "Config file path (default: java-runner2026.toml, then config/java-runner2026.toml)",
